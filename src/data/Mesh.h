...
namespace meshproc
{
	namespace data
	{
		...
		public:
			...
			inline void AddQuad(unsigned int i1, unsigned int i2, unsigned int i3, unsigned int i4, bool rotate = false)
			{
				if (rotate)
				{
					triangles.push_back(Triangle{ i1, i2, i4 });
					triangles.push_back(Triangle{ i3, i1, i4 });
				}
				else
				{
